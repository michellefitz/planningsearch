...
export const AUTHORITIES: AuthorityConfig[] = [
  ...
  },
  {
    ...
    shortName: "Cork City",
    sourceSystem: "agile",
    portalBaseUrl: "https://planning.agileapplications.ie/corkcity",
    agileSlug: "corkcity",
    gisUrl: null,
    nationalDbNames: ["Cork City Council", "Cork City"],
    nationalDbLike: "Cork City",
    portalUrlForReference: (ref) =>
      `https://planning.agileapplications.ie/corkcity/search-applications/?keyword=${encodeURIComponent(ref)}`,
    bbox: [-8.58, 51.85, -8.38, 51.93],
  },
  {
    id: "cork-county",
    ...
    sourceSystem: "agile",
    portalBaseUrl: "https://planning.agileapplications.ie/corkcoco",
    agileSlug: "corkcoco",
    gisUrl: null,
    nationalDbNames: ["Cork County Council", "Cork County"],
    nationalDbLike: "Cork County",
    portalUrlForReference: (ref) =>
      `https://planning.agileapplications.ie/corkcoco/search-applications/?keyword=${encodeURIComponent(ref)}`,
    bbox: [-10.2, 51.42, -7.85, 52.2],
  },
  {
    id: "wexford",
    ...
    shortName: "Wexford",
    sourceSystem: "agile",
    portalBaseUrl: "https://planning.agileapplications.ie/wexford",
    agileSlug: "wexford",
    gisUrl: null,
    nationalDbNames: ["Wexford County Council", "Wexford"],
    nationalDbLike: "Wexford",
    portalUrlForReference: (ref) =>
      `https://planning.agileapplications.ie/wexford/search-applications/?keyword=${encodeURIComponent(ref)}`,
    bbox: [-7.08, 52.17, -6.18, 52.66],
  },
  {
    id: "kildare",
